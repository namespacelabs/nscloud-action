...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            (0,external_console_namespaceObject.assert)([GITHUB_REPOSITORY, GITHUB_ACTOR, GITHUB_SHA].every(isDefined), "Missing required environment value. Are you running in GitHub Actions?");
